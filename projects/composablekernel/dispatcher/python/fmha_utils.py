...
def spec_to_config(
    ...
    # gfx12 (RDNA4) uses 16x16x16 WMMA warp tiles (not 32x32x16 like CDNA).
    # Wave config (4,1,1) — 4 warps total — matches the validated configs from
    # CK tile examples (PR #2528). The FmhaKernelConfig default is already (4,1,1),
    # so only the warp tile dimensions need overriding here.
